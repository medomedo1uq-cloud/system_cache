...
# Modified version - Added Temp Cleaner
# Colours
#-----------------
red="\e[91m"
rset="\e[0m"
...
echo -e "$red                        ➡$cyan [\e[92m8\e[96m] Clean Temp"   # <-- القسم الجديد
echo -e "$red                        ➡$cyan [\e[92m9\e[96m] Exit"         # <-- تم تغيير الرقم
echo " "
echo " "
...
# ---------- القسم الجديد: حذف محتويات مجلد temp ----------
cleanTemp(){
clear
echo -e "$red"
echo "======================================"
...
echo "======================================"
echo -e "$rset"
if [ -d "/storage/emulated/0/temp" ]; then
    rm -rf /storage/emulated/0/temp/*
    rm -rf /storage/emulated/0/temp/.* 2>/dev/null
    echo -e "$grn"
    echo "======================================"
...
echo " "
echo -ne "\e[92mPress Enter to return to menu...\e[0m"
read
banner
menu
}
